package fr.emmuliette.gmmod.gui.gmscreen.panels.rules;
...
@OnlyIn(Dist.CLIENT)
public class RulesPanel extends CustomScrollPanel {
...
//	private AvatarPanel avatar;
	...
	public RulesPanel(Minecraft mcIn, GmScreen parent, int widthIn, int heightIn, int top, int left) {
